...
class TestContestant(unittest.TestCase):
    ...
    def test_possible_matches(self):
        ...
        self.assertEqual(self.person.get_possible_matches(), [])
        self.assertEqual(self.person2.get_possible_matches(), [])

        self.person.set_possible_matches([self.person2])
        self.person2.set_possible_matches([self.person])
